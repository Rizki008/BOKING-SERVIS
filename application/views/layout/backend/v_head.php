...
<head>
    ...
    <title>Admin Laptop Solusindo</title>
    <!-- loader-->
    ...
    <!-- Vector CSS -->
    <link href="<?= base_url() ?>dashtreme-master/assets/plugins/vectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
    <!-- simplebar CSS-->
    <link href="<?= base_url() ?>dashtreme-master/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet" />
    <!-- Bootstrap core CSS-->
    ...
    <!-- Sidebar CSS-->
    <link href="<?= base_url() ?>dashtreme-master/assets/css/sidebar-menu.css" rel="stylesheet" />
    <!-- Custom Style-->
