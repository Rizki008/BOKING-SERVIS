...
<!-- simplebar js -->
<script src="<?= base_url() ?>dashtreme-master/assets/plugins/simplebar/js/simplebar.js"></script>
<!-- sidebar-menu js -->
<script src="<?= base_url() ?>dashtreme-master/assets/js/sidebar-menu.js"></script>
<!-- loader scripts -->
<script src="<?= base_url() ?>dashtreme-master/assets/js/jquery.loading-indicator.js"></script>
<!-- Custom scripts -->
<script src="<?= base_url() ?>dashtreme-master/assets/js/app-script.js"></script>
<!-- Chart js -->

<script src="<?= base_url() ?>dashtreme-master/assets/plugins/Chart.js/Chart.min.js"></script>

<!-- Index js -->
<script src="<?= base_url() ?>dashtreme-master/assets/js/index.js"></script>
